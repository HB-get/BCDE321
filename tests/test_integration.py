...
class TestIntegration:
    ...
    def test_items_gracefully_handles_having_invalid_item_added(self, none_components):
    ...
    # Reset ------------------------------------------------------------------------------------------------
    def test_reset_resets_all_components(self, none_components):
    ...
    # move_player ------------------------------------------------------------------------------------------------
    def test_north_move_is_allowed_at_start(self, none_components):
    ...
    def test_move_success_doesnt_allow_another_move(self, none_components):
        game, _, _, _, _ = none_components
    ...
    def test_can_only_move_north_at_start(self, none_components):
        game, _, _, _, _ = none_components
    ...
    def test_cant_move_after_placing_tile(self, none_components):
    ...
    # rotate_tile ------------------------------------------------------------------------------------------------
    def test_can_rotate_after_move(self, none_components):
        game, _, movement, _, _ = none_components
    ...
    def test_rotate_tile_only_allowed_after_move(self, none_components):
        game, _, movement, _, _ = none_components
    ...
    def test_move_failure_doesnt_allow_rotate(self, none_components):
        game, _, movement, _, _ = none_components
    ...
    # place_tile ------------------------------------------------------------------------------------------------
    def test_place_tile_works_after_move(self, none_components):
        game, _, _, _, _ = none_components
    ...
    def test_cant_place_tile_if_havent_moved(self, none_components):
        game, _, movement, _, _ = none_components
    ...
    def test_place_tile_cant_be_unaligned(self, none_components):
    ...
    def test_returning_to_known_tile_doesnt_require_place(self, none_components):
        game, _, _, _, _ = none_components
    ...
    # Zombie door ------------------------------------------------------------------------------------------------
    def test_zombie_door_pick_works_when_needed_after_none_event(self, none_components):
        _, state, movement, items, events = none_components
        game = Game(state, movement, items, events, map_seed=5)  # foyer -> bathroom
    ...
    def test_zombie_door_pick_works_when_needed_after_zombies_event(self, combat_components):
    ...
    def test_zombie_door_pick_works_when_needed_after_item_event(self, item_components):
    ...
    def test_zombie_door_pick_works_when_needed_after_health_event(self, none_components):
    ...
    def test_zombie_door_pick_without_need_fails(self, none_components):
        game, _, _, _, _ = none_components
    ...
    # attack ------------------------------------------------------------------------------------------------
    def test_attack_in_combat_works(self, combat_components):
    ...
    def test_attack_with_machete_calculates_damage_correctly(self, combat_components):
        game, state, movement, items, events = combat_components
        start_hp = state.get_hp()
    ...
    def test_attack_during_move_fails(self, none_components):
        game, _, _, _, _ = none_components
    ...
    def test_attack_during_item_search_fails(self, item_components):
    ...
    def test_attack_with_chainsaw_and_fuel_works(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_attack_with_chainsaw_without_fuel_fails(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_attack_with_chainsaw_without_chainsaw_fails(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_attack_with_instant_kill_does_no_damage(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_attack_with_instant_kill_without_items_fails(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    # flee ------------------------------------------------------------------------------------------------
    def test_flee_from_combat_works(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_flee_to_unexplored_tile_fails(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_flee_without_oil_does_damage(self, combat_components):
        game, state, movement, items, events = combat_components
        start_hp = state.get_hp()
    ...
    def test_flee_with_oil_does_no_damage(self, combat_components):
        game, state, movement, items, events = combat_components
        start_hp = state.get_hp()
    ...
    def test_flee_with_oil_without_oil_fails(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_flee_during_item_search_fails(self, item_components):
        game, _, _, _, _ = item_components
    ...
    def test_flee_during_move_fails(self, none_components):
        game, _, _, _, _ = none_components
    ...
    # end_turn ------------------------------------------------------------------------------------------------
    def test_end_turn_with_health_tile_effect_heals(self, combat_components):
        _, state, movement, items, events = combat_components
    ...
    def test_end_turn_with_cower_restores_health(self, none_components):
    ...
    def test_end_turn_with_item_tile_effect_lets_item_search(self, none_components):
        _, state, movement, items, events = none_components
    ...
    def test_end_turn_with_find_totem_draws_card_and_doesnt_win(self, none_components):
        _, state, movement, items, events = none_components
    ...
    def test_end_turn_with_bury_totem_without_totem_fails(self, none_components):
        _, state, movement, items, _ = none_components
        events = Events((DevCard(
            (
                CardEffect(CardEffectType.NONE),
    ...
    def test_end_turn_during_move_fails(self, none_components):
        game, _, _, _, _ = none_components
        game.move_player(Direction.NORTH)
    ...
    def test_end_turn_during_combat_fails(self, combat_components):
        game, state, movement, items, events = combat_components
    ...
    def test_end_turn_during_item_search_fails(self, item_components):
        game, _, _, _, _ = item_components
    ...
    def test_search_for_item_doesnt_fail(self, item_components):
    ...
    def test_search_for_item_during_move_fails(self, item_components):
        game, _, _, _, _ = item_components
        game.move_player(Direction.NORTH)
    ...
    def test_ignore_search_during_search_doesnt_fail(self, item_components):
    ...
    def test_ignore_search_not_during_move_fails(self, item_components):
        game, _, _, _, _ = item_components
        game.move_player(Direction.NORTH)
    ...
    # take_item ------------------------------------------------------------------------------------------------
    def test_take_item_with_found_gives_that_item(self, item_components):
        game, _, _, items, _ = item_components
        game.move_player(Direction.NORTH)
        game.place_tile()
    ...
    def test_take_item_during_move_fails(self, item_components):
        game, _, _, _, _ = item_components
        game.move_player(Direction.NORTH)
    ...
    def test_take_item_with_full_inventory_fails(self, item_components):
        game, _, _, items, _ = item_components
        game.move_player(Direction.NORTH)
    ...
    # dont_take_item ------------------------------------------------------------------------------------------------
    def test_dont_take_item_works(self, item_components):
        game, _, _, items, _ = item_components
        game.move_player(Direction.NORTH)
        game.place_tile()
    ...
    def test_dont_take_item_during_move_fails(self, item_components):
        game, _, _, _, _ = item_components
        game.move_player(Direction.NORTH)
    ...
    def test_dont_take_item_with_full_inventory_doesnt_fail(self, item_components):
        game, _, _, items, _ = item_components
        game.move_player(Direction.NORTH)
    ...
    # discard_item ------------------------------------------------------------------------------------------------
    def test_discard_item_with_item_works(self, none_components):
        game, _, _, items, _ = none_components
    ...
    def test_discard_item_with_no_item_fails(self, none_components):
        game, _, _, items, _ = none_components
    ...
    # use_item ------------------------------------------------------------------------------------------------
    def test_use_gasoline_with_gasoline_and_chainsaw_refuels(self, combat_components):
    ...
    def test_use_soda_heals(self, none_components):
    ...
    def test_use_other_items_fails(self, none_components):
    ...
    def test_use_gasoline_without_gasoline_fails(self, none_components):
        game, _, _, items, _ = none_components
        items.find_item(ItemCode.CHAINSAW)
        items.keep_found_item()
    ...
    def test_use_gasoline_without_chainsaw_fails(self, none_components):
        game, _, _, items, _ = none_components
        items.find_item(ItemCode.GASOLINE)
        items.keep_found_item()
    ...
    def test_use_soda_without_soda_fails(self, none_components):
        game, state, _, _, _ = none_components
        start_hp = state.get_hp()
    ...
    def test_exhaust_hp_loses(self, combat_components):
    ...
    def test_out_of_time_loses(self, none_components):
        _, state, movement, items, _ = none_components
        events = Events((DevCard(
            (
                CardEffect(CardEffectType.NONE),
    ...
    def test_not_buried_hp_left_not_out_of_time_does_nothing(self, none_components):
        game, _, _, _, _ = none_components
    ...
    def test_end_turn_with_bury_totem_with_totem_draws_card_and_wins(self, none_components):
        _, state, movement, items, _ = none_components
        events = Events((DevCard(
            (
                CardEffect(CardEffectType.NONE),
        ...
        game = Game(state, movement, items, events,
                    map_seed=408)  # foyer -> evil temple -> family room -> patio -> graveyard
