...
class TestGameMapCreateZombieDoor:
    # ========================== Good Day ========================== #

    def test_create_zombie_door_when_given_valid_direction_to_empty_tile_returns_none_and_creates_zombie_door_in_correct_direction(
            self) -> None:
        # Arrange
    ...
    def test_create_zombie_door_when_given_invalid_direction_returns_direction_error(self, direction) -> None:
        # Arrange
    ...
    def test_create_zombie_door_when_given_invalid_direction_to_out_of_bounds_position_returns_out_of_bounds_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_create_zombie_door_when_given_invalid_direction_to_known_tile_returns_zombie_door_known_tile_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_create_zombie_door_without_locking_tile_returns_placement_mode_error_and_does_not_move_player(
            self) -> None:
        # Arrange
