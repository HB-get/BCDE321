...
class TestGameMapMove:
    # ========================== Good Day ========================== #

    def test_move_when_given_valid_direction_to_empty_tile_returns_none_and_turns_on_placement_mode(self) -> None:
        # Arrange
    ...
    def test_move_when_given_valid_direction_to_empty_tile_does_not_move_player_to_tile(self) -> None:
        # Arrange
    ...
    def test_move_when_given_valid_direction_to_know_tile_returns_none_and_does_not_turn_on_placement_mode(
            self) -> None:
        # Arrange
    ...
    def test_move_when_given_valid_direction_to_known_tile_moves_player_to_tile(self) -> None:
        # Arrange
    ...
    def test_move_when_given_invalid_direction_returns_direction_error(self, direction) -> None:
        # Arrange
        movement = GameMap(map_dimensions=(5, 5), starting_position=(2, 2))
    ...
    def test_move_when_given_invalid_direction_to_out_of_bounds_position_returns_out_of_bounds_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_move_when_given_invalid_direction_to_empty_tile_with_no_door_returns_no_door_error_and_does_not_move_player(
            self) -> None:
        # Arrange
        starting_position = (2, 2)
        movement = GameMap(map_dimensions=(5, 5), starting_position=starting_position, randomizer_seed=42)
    ...
    def test_move_when_given_invalid_direction_to_known_tile_with_no_door_returns_no_door_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_move_when_given_invalid_direction_to_different_area_returns_across_area_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_move_to_new_inside_when_all_inside_explored_returns_depleted_inside_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_move_to_new_outside_when_all_outside_explored_returns_depleted_outside_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_move_without_locking_tile_returns_placement_mode_error_and_does_not_move_player(self) -> None:
        # Arrange
        starting_position = (2, 2)
    ...
    def test_move_when_player_actions_cause_unplaceable_tile_returns_fatal_tile_error_and_does_not_move_player(
            self) -> None:
        # Arrange
        current_position = (1, 4)
