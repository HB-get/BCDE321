...
class TestGameMapNeedZombieDoor:
    # ========================== Good Day ========================== #

    def test_need_zombie_door_when_normal_door_open_to_empty_tile_returns_false(self) -> None:
        # Arrange
    ...
    def test_need_zombie_door_when_no_normal_door_open_to_empty_tile_returns_true(self) -> None:
        # Arrange
    ...
    def test_need_zombie_door_when_only_normal_door_open_to_out_of_bounds_returns_true(self) -> None:
        # Arrange
    ...
    def test_need_zombie_door_when_only_open_door_is_exit_door_returns_true(self) -> None:
        # Arrange
    ...
    def test_need_zombie_door_when_no_open_normal_door_and_all_insides_explored_returns_false(self) -> None:
        # Arrange
    ...
    def test_need_zombie_door_when_no_open_normal_door_and_all_outsides_explored_returns_false(self) -> None:
        # Arrange
