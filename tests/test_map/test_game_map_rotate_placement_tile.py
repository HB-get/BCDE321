...
class TestGameMapRotatePlacementTile:
    # ========================== Good Day ========================== #

    def test_rotate_placement_tile_doors_are_rotated_and_returns_none(self) -> None:
        # Arrange
    ...
    def test_rotate_placement_tile_rotated_exit_door_transition_is_not_blocked(self) -> None:
        # Arrange
    ...
    def test_rotate_placement_tile_rotated_entry_door_transition_aligns_with_exit(self) -> None:
        # Arrange
    ...
    def test_rotate_placement_tile_rotating_locked_tile_returns_rotate_tile_error(self) -> None:
        # Arrange
