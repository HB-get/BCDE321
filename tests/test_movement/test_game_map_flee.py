...
class TestGameMapFlee():
    # ========================== Good Day ========================== #

    def test_flee_when_given_valid_direction_to_know_tile_returns_none_and_moves_player_to_tile(self) -> None:
        # Arrange
    ...
    def test_flee_when_given_invalid_direction_returns_direction_error(self, direction) -> None:
        # Arrange
    ...
    def test_flee_when_given_invalid_direction_to_out_of_bounds_position_returns_out_of_bounds_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_flee_when_given_invalid_direction_to_empty_tile_returns_flee_error_and_does_not_move_player(self) -> None:
        # Arrange
    ...
    def test_flee_when_given_invalid_direction_to_known_tile_with_no_door_returns_no_door_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_flee_when_given_invalid_direction_to_different_area_returns_across_area_error_and_does_not_move_player(
            self) -> None:
        # Arrange
    ...
    def test_flee_without_locking_tile_returns_placement_mode_error_and_does_not_move_player(self) -> None:
        # Arrange
