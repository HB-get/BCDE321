...
class TestGameMapInitialization:
    ...
    def test_init_when_given_valid_map_dimensions_sets_map_dimensions(self) -> None:
        # Arrange
        map_dimensions = (4, 5)
    ...
    def test_init_when_given_valid_starting_position_sets_player_position(self) -> None:
        # Arrange
    ...
    def test_init_when_given_valid_seed_keeps_tile_order_consistent(self) -> None:
        # Arrange
        map_dimensions = (4, 5)
        starting_position = (2, 2)
        seed = 42
    ...
    def test_init_when_given_no_map_dimensions_default_map_dimensions_is_used(self) -> None:
        # Arrange
    ...
    def test_init_when_given_no_starting_position_default_starting_position_is_used(self) -> None:
        # Arrange
    ...
    def test_init_when_given_invalid_map_dimensions_type_raises_type_error_with_correct_message(self,
    ...
    def test_init_when_given_invalid_map_dimensions_value_raises_value_error_with_correct_message(self,
                                                                                                  map_dimensions: tuple[
                                                                                                      int, int]) -> None:
        # Arrange
        starting_position = (2, 2)
    ...
    def test_init_when_given_invalid_starting_position_type_raises_type_error_with_correct_message(self,
                                                                                                   starting_position:
                                                                                                   tuple[
                                                                                                       int, int]) -> None:
        # Arrange
    ...
    def test_init_when_given_invalid_starting_position_value_raises_value_error_with_correct_message(self,
                                                                                                     starting_position:
                                                                                                     tuple[
                                                                                                         int, int]) -> None:
        # Arrange
    ...
    def test_init_when_given_invalid_randomizer_seed_value_raises_value_error_with_correct_message(self) -> None:
        # Arrange
        map_dimensions = (4, 5)
        starting_position = (2, 2)
        invalid_seed = "42"
