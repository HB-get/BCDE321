...
class TestGameMapLockPlacementTile:
    # ========================== Good Day ========================== #

    def test_lock_placement_tile_tile_is_locked_and_returns_none(self) -> None:
        # Arrange
    ...
    def test_lock_placement_tile_player_is_moved_to_tile(self) -> None:
        # Arrange
        player_position = (1, 3)
    ...
    def test_lock_placement_tile_locking_a_locked_tile_returns_lock_tile_error(self) -> None:
        # Arrange
