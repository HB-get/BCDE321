...
class TestGameMapReset:
    # ========================== Good Day ========================== #

    def test_reset_when_given_valid_map_dimensions_sets_map_dimensions(self) -> None:
        # Arrange
    ...
    def test_reset_when_given_no_map_dimensions_previous_map_dimensions_are_used(self) -> None:
        # Arrange
        map_dimensions = (4, 4)
    ...
    def test_reset_when_given_valid_starting_position_sets_player_position(self) -> None:
        # Arrange
    ...
    def test_reset_when_given_no_starting_position_previous_map_dimensions_are_used(self) -> None:
        # Arrange
    ...
    def test_reset_when_given_valid_seed_keeps_tile_order_consistent(self) -> None:
        # Arrange
        map_dimensions = (4, 5)
    ...
    def test_reset_clears_all_discovered_tiles(self) -> None:
        # Arrange
    ...
    def test_reset_when_given_invalid_map_dimensions_type_returns_map_dimensions_type_error(self,
    ...
    def test_reset_when_given_invalid_map_dimensions_value_returns_map_dimensions_value_error(self,
                                                                                              map_dimensions: tuple[
                                                                                                  int, int]) -> None:
        # Arrange
    ...
    def test_reset_when_given_invalid_starting_position_type_returns_starting_position_type_error(self,
                                                                                                  starting_position:
                                                                                                  tuple[
                                                                                                      int, int]) -> None:
        # Arrange
    ...
    def test_reset_when_given_invalid_starting_position_value_returns_starting_position_value_error(self,
                                                                                                    starting_position:
                                                                                                    tuple[
                                                                                                        int, int]) -> None:
        # Arrange
    ...
    def test_reset_when_given_invalid_starting_position_and_map_dimensions_returns_starting_position_error(self,
                                                                                                           map_dimensions:
                                                                                                           tuple[
                                                                                                               int, int],
                                                                                                           starting_position:
    ...
    def test_reset_when_given_invalid_randomizer_seed_type_returns_randomizer_seed_type_error(self) -> None:
        # Arrange
        movement = GameMap(map_dimensions=(5, 4), starting_position=(4, 1), randomizer_seed=1)
        invalid_seed = "42"
